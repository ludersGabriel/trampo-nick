...
export const appendListaMecanicas = () => {
...
const addNameButton = document.getElementById('addMecanica')
addNameButton.onclick = appendMecanica

const runChooseButton = document.getElementById('runChooseMecanica')
runChooseButton.onclick = chooseMecanic
